  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <StatCard title="Net Balance" amount="5,80,000" currency="₹" icon={<FaDollarSign />} color="text-blue-500" />
        <StatCard title="Tax Estimate" amount="2,00,000" currency="₹" icon={<FaDollarSign />} color="text-purple-500" />
        <StatCard title="Savings Rate" amount="25" currency="%" icon={<FiPercent />} color="text-indigo-500" />
